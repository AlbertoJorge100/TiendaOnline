<%-- 
    ...
    Created on : 15-nov-2019, 23:26:09
    Author     : Alberto
--%>
                        ...
                        <div class="col-sm-3">
                            <div class="shop-menu pull-right">
                                <ul class="nav navbar-nav">
                                    <li><a href="registro.jsp"><i class="fa fa-check"></i> Registrarse</a></li>
                                    <%!String url;%>
                                    <%url="login.jsp?idProducto="+pro.getIdProducto()+"";%>
                                    <li><a href=<%=url%>><i class="fa fa-lock"></i>Iniciar Sesion</a></li>
                                </ul>
                            </div>
                        </div>	
                    </div>
                                ...
                                <div class="col-sm-7">
                                    <div class="product-information"><!--/product-information-->
                                        ...
                                        <span>
                                            ...
                                            <%String variable="login.jsp?idProx="+idPro+"";%>
                                            <a href=<%=variable%>>                                                
                            ...
                            <div class="category-tab shop-details-tab">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade active in" id="reviews" >
                                        <div class="col-sm-12">
                                            <ul>
                                                <li><a href=""><i class="fa fa-user"></i>Usuario Visitante</a></li>
                                                <li><a href=""><i class="fa fa-clock-o"></i><%=new Date()%></a></li>
